...
describe("dsl", () => {
  ...
  it("ability to include counts", () => {
    ...
    expect(inflector.pluralize(5, "cat", { withoutCount: true })).toBe(
      "cats",
      "without count"
    );
  });
  ...
  it("ability to add additional pluralization rules", () => {
    ...
    expect(inflector.pluralize("cow")).toBe(
      "cows",
  ...
  it("ability to add additional singularization rules", () => {
    expect(inflector.singularize("cows")).toBe(
      "cows",
  ...
  it("ability to add additional uncountable rules", () => {
    ...
    expect(inflector.pluralize("redCow")).toBe(
      "redCow",
      "pluralization rule NOT was applied"
    );
    expect(inflector.pluralize("red-cow")).toBe(
      "red-cow",
      "pluralization rule NOT was applied"
    );
    expect(inflector.pluralize("red/cow")).toBe(
  ...
  it("ability to add additional irregular rules", () => {
    ...
    expect(inflector.singularize("red-cows")).toBe(
      "red-cow",
      "regular singularization rule was applied"
    );
    expect(inflector.pluralize("red-cow")).toBe(
    ...
    expect(inflector.singularize("redCows")).toBe(
      "redCow",
      "regular singularization rule was applied"
    );
    expect(inflector.pluralize("redCow")).toBe(
    ...
    expect(inflector.singularize("kine")).toBe(
      "cow",
    ...
    expect(inflector.singularize("red-kine")).toBe(
      "red-cow",
      "irregular singularization rule was applied"
    );
    expect(inflector.pluralize("red-cow")).toBe(
    ...
    expect(inflector.singularize("red-red-cow")).toBe(
      "red-red-cow",
      "irregular singularization rule was applied correctly with dasherization"
    );
    expect(inflector.singularize("red-red-kine")).toBe(
      "red-red-cow",
      "irregular singularization rule was applied correctly with dasherization"
    );
    expect(inflector.pluralize("red-red-cow")).toBe(
      "red-red-kine",
      "irregular pluralization rule was applied correctly with dasherization"
    );
    expect(inflector.pluralize("red-red-kine")).toBe(
      "red-red-kine",
      "irregular pluralization rule was applied correctly with dasherization"
    );

    expect(inflector.singularize("redKine")).toBe(
      "redCow",
      "irregular singularization rule was applied"
    );
    expect(inflector.pluralize("redCow")).toBe(
  ...
  it("ability to add identical singular and pluralizations", () => {
    ...
    expect(inflector.singularize("settings")).toBe(
      "setting",
      "regular singularization rule was applied"
    );
    expect(inflector.pluralize("setting")).toBe(
      "settings",
      "regular pluralization rule was applied"
    );
    ...
    expect(inflector.pluralize("settings")).toBe(
      "settings",
      "irregular pluralization rule was applied on lowercase word"
    );

    expect(inflector.singularize("userPreferences")).toBe(
      "userPreferences",
      "irregular singularization rule was applied on camelcase word"
    );
    expect(inflector.pluralize("userPreferences")).toBe(
      "userPreferences",
...
describe("unit", () => {
  ...
  it("inflect.irregular", () => {
    ...
    expect(inflector.inflect("word", rules, inflector.rules.irregular)).toBe(
      "wordy"
    );
    expect(
